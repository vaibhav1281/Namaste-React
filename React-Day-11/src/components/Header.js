  ...
  return (
    <div className='w-full h-[80px] sticky shadow-md flex justify-center top-0 bg-white z-10'>
                ...
                <ul className='flex space-x-9 flex-wrap  justify-center'>
                    ...
                    <li>
                        <button 
                            ...
                            className='flex space-x-2 hover:text-orange-500 group items-center h-[80px] cursor-pointer'>
                            <span>
                                <svg className='group-hover:fill-orange-500' 
                            ...
                            >Sign In</span>
                            <Profile showProfile={showProfile} closeProfile={() => setShowProfile(false)} />
                        </button>
                        ...
                        <Link className='flex space-x-2 hover:text-orange-500 group items-center h-[80px]' 
                            ...
                            <span
                                ...
                                <svg
                                    ...
                                    {/* Cart Item Size */}
                                    <text x="10" y="21" className='fill-white text-xl  items-center stroke-orange-500'>{cartItems.length}</text>
                                </svg>
        ...
        <div className='sm:hidden relative flex items-cente '>
            ...
            {/* Profile */}
            <div to={'/vaibhav/profile'} className=" flex items-center mr-4">
                <svg onClick={() => setShowProfile(true)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#686b78" className="w-10 h-10">
